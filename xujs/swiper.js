...
(function () {
    ...
    var Swiper = function (container, params) {
        ...
        var defaults = {
            ...
            autoplayDisableOnInteraction: true,                                            /////滑过之后继续调用................
            //autoplayStopOnLast:如果设置为true，当切换到最后一个slide时停止自动切换 （loop模式下无效） 或者将loop的值设置为false
            ...
            // Autoheight
            autoHeight: false, //自动高度。设置为true时，wrapper和container会随着当前slide的高度而发生变化。  默认为false
            // Set wrapper width
